...
You can also project an entire entity instead of an individual column. This is fully supported by Yawn. For example, the following query returns the publishers of books whose names start with `The`:
